...
## 📌 프로젝트 목적
정교한 물류 관리 및 배송 프로세스를 구축하여, 상품의 이동을 최적화하고 배송을 체계적으로 운영할 수 있는 스마트 물류 시스템을 개발하는 것이 목표입니다.

효율적인 허브 간 이동 경로 관리, 실시간 재고 및 배송 추적, 자동화된 배송 프로세스를 통해 물류 흐름을 한층 더 정밀하게 조율하며 데이터 기반 의사결정을 지원하는 물류 플랫폼을 구축하고자 합니다. 🚛📦
</br>
</br>
...
## 🚨 Trouble Shooting
### MSA 내 인증 전파 트러블 [WIKI](https://github.com/O-n-Logistics/backend/wiki/%5BTrouble-Shooting%5D-MSA-%EB%82%B4-%EC%9D%B8%EC%A6%9D-%EC%A0%84%ED%8C%8C-%ED%8A%B8%EB%9F%AC%EB%B8%94)
### OpenFeign 실패 요청 예외 처리 트러블 [WIKI](https://github.com/O-n-Logistics/backend/wiki/%5BTrouble-Shooting%5D-OpenFeign-%EC%8B%A4%ED%8C%A8-%EC%9A%94%EC%B2%AD-%EC%98%88%EC%99%B8%EC%B2%98%EB%A6%AC-%ED%8A%B8%EB%9F%AC%EB%B8%94)
</br>
</br>
